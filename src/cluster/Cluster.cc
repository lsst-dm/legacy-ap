...
/** @file
  ...
  */
#include "lsst/ap/optics/Cluster.h"
...
#include "lsst/ap/optics/detail/Optics.cc"
...
typedef detail::Optics<3, detection::Source::Ptr> Optics;
    ...
    lsst::pex::policy::Policy::Ptr policy)
{
    ...
    if (i > 0) {
        ...
        optics.run(clusters, detail::SquaredEuclidianDistanceOverSphere());
    }
    return clusters;
}
