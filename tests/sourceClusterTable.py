...
class SourceClusterTableTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.coordErrKey = self.schema.addField("coord.err", type="Cov<Point<F8>>")
        self.numSourcesKey = self.schema.addField("obs.num", type="I4")
        self.timeMinKey = self.schema.addField("obs.time.min", type="F8")
        self.timeMaxKey = self.schema.addField("obs.time.max", type="F8")
        self.uFluxKey = self.schema.addField("u.flux", type="F8")
        self.uFluxErrKey = self.schema.addField("u.flux.err", type="F8")
        self.uFluxCountKey = self.schema.addField("u.flux.count", type="I4")
        self.zFluxKey = self.schema.addField("z.flux", type="F8")
        self.zFluxErrKey = self.schema.addField("z.flux.err", type="F8")
        self.zFluxCountKey = self.schema.addField("z.flux.count", type="I4")
        self.gShapeKey = self.schema.addField("g.shape", type="Moments<F8>")
        self.gShapeErrKey = self.schema.addField("g.shape.err", type="Cov<Moments<F8>>")
        self.gShapeCountKey = self.schema.addField("g.shape.count", type="I4")
        self.rNumSourcesKey = self.schema.addField("r.obs.num", type="I4")
        self.rTimeMinKey = self.schema.addField("r.obs.time.min", type="F8")
        self.rTimeMaxKey = self.schema.addField("r.obs.time.max", type="F8")
