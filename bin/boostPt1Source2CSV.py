...
def sources2CSV(sources, csvWriter, nullstr):
    for s in sources:
        ...
        row.append(translate(s, Source.getPsfIxx, nullstr, afwDetection.PSF_IXX))
        row.append(translate(s, Source.getPsfIxxErr, nullstr, afwDetection.PSF_IXX_ERR))
        row.append(translate(s, Source.getPsfIyy, nullstr, afwDetection.PSF_IYY))
        row.append(translate(s, Source.getPsfIyyErr, nullstr, afwDetection.PSF_IYY_ERR))
        row.append(translate(s, Source.getPsfIxy, nullstr, afwDetection.PSF_IXY))
        row.append(translate(s, Source.getPsfIxyErr, nullstr, afwDetection.PSF_IXY_ERR))
        row.append(translate(s, Source.getE1, nullstr, afwDetection.E1))
        row.append(translate(s, Source.getE1Err, nullstr, afwDetection.E1_ERR))
        row.append(translate(s, Source.getE2, nullstr, afwDetection.E2))
        row.append(translate(s, Source.getE2Err, nullstr, afwDetection.E2_ERR))
        row.append(translate(s, Source.getResolution, nullstr, afwDetection.RESOLUTION))
        row.append(translate(s, Source.getShear1, nullstr, afwDetection.SHEAR1))
        row.append(translate(s, Source.getShear1Err, nullstr, afwDetection.SHEAR1_ERR))
        row.append(translate(s, Source.getShear2, nullstr, afwDetection.SHEAR2))
        row.append(translate(s, Source.getShear2Err, nullstr, afwDetection.SHEAR2_ERR))
        row.append(translate(s, Source.getSigma, nullstr, afwDetection.SIGMA))
        row.append(translate(s, Source.getSigmaErr, nullstr, afwDetection.SIGMA_ERR))
        row.append(translate(s, Source.getShapeStatus, nullstr, afwDetection.SHAPE_STATUS))
